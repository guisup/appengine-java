 ...
 * {@link http://code.google.com/apis/storage/}
 *
 */
public class GSFileOptions {
  ...
  private GSFileOptions(String bucket,
    ...
    this.acl = (acl == null || acl.trim().isEmpty()) ? FileServiceImpl.GS_DEFAULT_ACL : acl;
  ...
  public static class GSFileOptionsBuilder {
   ...
   /**
    ...
    /**
     * Sets the acl of the object. If not set, defaults to private.
