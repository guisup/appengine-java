...
public final class IMHandle implements Serializable, Comparable<IMHandle> {
   ...
   *
   * @throws IllegalArgumentException If the provided string does not match the
   * format returned by {@link #toDatastoreString()} or the first component of
   * the string is not a valid {@link Scheme} and is not a valid {@link URL}.
   */
  ...
  /**
   * The datastore representation of the {@code IMHandle}.
