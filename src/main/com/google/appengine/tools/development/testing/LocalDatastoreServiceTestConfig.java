...
public final class LocalDatastoreServiceTestConfig implements LocalServiceTestConfig {
  ...
  private Boolean noStorage = true;private Integer maxQueryLifetimeMs;private Integer maxTxnLifetimeMs;private Integer storeDelayMs;private String backingStoreLocation;
  ...
  public void setUp() {
    ...
    proxy.setProperty(LocalDatastoreService.NO_STORAGE_PROPERTY, noStorage.toString());
    ...
    proxy.setProperty(LocalDatastoreService.NO_INDEX_AUTO_GEN_PROP, noIndexAutoGen.toString());
    if (defaultHighRepJobPolicyRandomSeed != null) {
